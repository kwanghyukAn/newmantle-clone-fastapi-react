...
export function SoloPage({ playerName }: Props) {
  ...
  return (
    <section className="stack">
      <div className="sheet-block">
        ...
        <div className="sheet-block-body">
          ...
          <div className="sheet-row">
            ...
            <div className="sheet-row-cells status-banner">
              {state?.completed ? (
      ...
      {embeddingInfo ? (
        <div className="sheet-block compact-sheet-block">
          <div className="sheet-block-columns">
            <span>E</span>
            <span>F</span>
            <span>G</span>
          ...
          <div className="sheet-block-body">
            ...
            <div className="sheet-row">
              <div className="sheet-row-number">7</div>
              <div className="sheet-row-cells">
            ...
            <div className="sheet-row">
              <div className="sheet-row-number">8</div>
              <div className="sheet-row-cells">
